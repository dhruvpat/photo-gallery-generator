  ...
  <div class="page-content">
	...
	@endif	
		...
		<ul class="parsley-error-list">
		 ...
		 {{ Form::open(array('url'=>'pages/save/'.SiteHelpers::encryptID($row['pageID']), 'class'=>'form-vertical','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
