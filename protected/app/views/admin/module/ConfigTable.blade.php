 ...
 <div class="table-responsive">
		...
		<?php usort($tables, "SiteHelpers::_sort"); ?>
          ...
          <tr >
            ...
            <td ><input name="label[<?php echo $id;?>]" type="text" class="form-control" id="label" value="<?php echo $rows['label'];?>" />           </td>
            <td>
			<label >
...
<style>
	.expand-row { box-shadow:0px 1px 1px #ddd; display:inline; position:absolute;  left:50%; width:500px;  background:#f9f9f9; border:solid 1px #ddd; padding:2px;}
