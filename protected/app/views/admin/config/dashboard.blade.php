	...
	<div class="col-sm-12 col-md-12">
		<div class="panel panel-default ">
			...
			<ul class="info-blocks">
			  <li class="">
				<div class="top-info"><a href="{{ URL::to('Posts') }}">Posts</a><small>Manage Posts</small></div>
				<a href="{{ URL::to('Posts') }}"><i class="icon-blog"></i></a></li></li>
			  <li class="">
				<div class="top-info"><a href="{{ URL::to('Images') }}">Images</a><small>Manage Images</small></div>
				<a href="{{ URL::to('Images') }}"><i class="icon-image"></i></a></li></li>
			</ul>
		</div>
	</div>
		...
		<div class="panel panel-default ">
			...
			<ul class="info-blocks">
			  <li class="">
				...
				<a href="{{ URL::to('module/add') }}"><i class="icon-pencil"></i></a></li>
			  <li class="">
